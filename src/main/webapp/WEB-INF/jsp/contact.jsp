...
<body>
	<div class="front">
		...
		<div class="hero-text">
			<h1>CONTACT US</h1>
			<h4>We'll help you out</h4>
		</div>
	</div>

	<!-- Body Section Of the page begins -->


	<h1 class="midtext">" We are available on a lot of social media
		platforms "</h1>
	<h5>Contact us on</h5>
	<div class="social">
		<div class="col2">
			<img alt="facebook" src="images/icons/facebook.png" class="fig2">
		</div>
		<div class="col2">
			<img alt="gmail" src="images/icons/gmail.png" class="fig2">
		</div>
		<div class="col2">
			<img alt="instagram" src="images/icons/instagram.png" class="fig2">
		</div>
		<div class="col2">
			<img alt="twitter" src="images/icons/twitter.png" class="fig2">
		</div>
	</div>
	...
	<div class="trending">
		...
		<div class="col1">
			<a href="https://en.wikipedia.org/wiki/Manali,_Himachal_Pradesh"
				target="_blank"><img alt="Manali" src="images/cities/manali.jpg"
				class="fig"></a>
			<div class="text">
				<b>Manali</b>
			</div>
