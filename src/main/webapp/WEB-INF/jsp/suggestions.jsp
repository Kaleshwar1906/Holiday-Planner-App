...
<body>
	...
	<spring:forEach items="${suggestions}" var="obj">
		<spring:set var="s" value="${obj.name}"></spring:set>
		<spring:set var="str" value="${fn:toUpperCase(s)}"></spring:set>
		<table>
			<tr>
				<td><a href="${obj.href}"><img alt="${obj.name}"
						src="${obj.imgsrc}" class="fig"></a></td>
				<td class="data"><h2>
						<p>${str}</p>
					</h2></td>
				<td><p class="data1">:Best Viewed in ${obj.days} days</p></td>
			</tr>
		</table>
	</spring:forEach>
