...
<link rel="stylesheet" href="css/accomodate.css">
...
<body>
	...
	<c:set var="accomodate" value="Hotel Luxury"></c:set>

	<div class="loc">
		<div class="column1">
			<img alt="Hotel" src="images/icons/hotel1.png" class="fig">
		</div>
		<div class="column2">
			<ul style="list-style-type: none;">
				<li><h1>Hotel Luxury</h1></li>
				<li><p>Cost: 2000 Rs/day per head-</p></li>
				<li><p>Rooms Available</p></li>
				<li><p>Free Parking, Free Wifi</p></li>
				<li><p>
						<a href="/plan/${accomodate}/hotel">Select Hotel</a>
					</p></li>
			</ul>
		</div>
	</div>

	<c:set var="accomodate" value="Hotel Affordable"></c:set>

	<div class="loc">
		<div class="column1">
			<img alt="Hotel" src="images/icons/hotel2.png" class="fig">
		</div>
		<div class="column2">
			<ul style="list-style-type: none;">
				<li><h1>Hotel Affordable</h1></li>
				<li><p>Cost: 1000 Rs/day per head -</p></li>
				<li><p>Rooms Available</p></li>
				<li><p>Free Parking, Free Wifi</p></li>
				<li><p>
						<a href="/plan/${accomodate}/hotel">Select Hotel</a>
	...
	<c:set var="accomodate" value="Hotel Budget"></c:set>

	<div class="loc">
		<div class="column1">
			<img alt="Hotel" src="images/icons/hotel3.png" class="fig">
		</div>
		<div class="column2">
			<ul style="list-style-type: none;">
				<li><h1>Hotel Budget</h1></li>
				<li><p>: 500 Rs/day per head-</p></li>
				<li><p>Rooms Available</p></li>
				<li><p>Free breakfast</p></li>
				<li><p>
						<a href="/plan/${accomodate}/hotel">Select Hotel</a>
					</p></li>
			</ul>
