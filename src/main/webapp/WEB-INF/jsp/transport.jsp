...
<body>
	...
	<c:set var="transport" value="Flight"></c:set>

	<div class="loc">
		<div class="column1">
			<img alt="flight" src="images/icons/flight.png" class="fig">
		</div>
		<div class="column2">
			<ul style="list-style-type: none;">
				<li><h1>Flight</h1></li>
				<li><p>Cost: 4 Rs per kilometer per head-</p></li>
				<li><p>Bookings Available</p></li>
				<li><p>Fastest means of travel. You save travelling time in
						the process</p></li>
				<li><p>
						<a href="plan/${transport}/travel">Select Transport</a>
					</p></li>
			</ul>
		</div>
	</div>

	<c:set var="transport" value="Train"></c:set>

	<div class="loc">
		<div class="column1">
			<img alt="train" src="images/icons/train.png" class="fig">
		</div>
		<div class="column2">
			<ul style="list-style-type: none;">
				<li><h1>Train</h1></li>
				...
				<li><p>Cheapest and Faster means of travel</p></li>
				<li><p>
						<a href="plan/${transport}/travel">Select Transport</a>
					</p></li>
			</ul>
	...
	<c:set var="transport" value="Bus"></c:set>

	<div class="loc">
		<div class="column1">
			<img alt="bus" src="images/icons/bus.png" class="fig">
		</div>
		<div class="column2">
			<ul style="list-style-type: none;">
				<li><h1>Bus</h1></li>
				...
				<li><p>Bookings Available</p></li>
				<li><p>
						Slowest means to travel. But you are saving fuel, <b>Go Green</b>
					</p></li>
				<li><p>
						<a href="plan/${transport}/travel">Select Transport</a>
					</p></li>
	...
	<c:set var="transport" value="Car"></c:set>

	<div class="loc">
		<div class="column1">
			<img alt="car" src="images/icons/car.png" class="fig">
		</div>
		<div class="column2">
			<ul style="list-style-type: none;">
				<li><h1>Car</h1></li>
				<li><p>: Cost: 3 Rs per kilometer per head -</p></li>
				<li><p>Own Car/ Rental</p></li>
				<li><p>Faster transport.</p></li>
				<li><p>
						<a href="plan/${transport}/travel">Select Transport</a>
					</p></li>
			</ul>
